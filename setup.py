...
setup(
    name='WebCrawler',
    version='',
    packages=['venv.Lib.site-packages.get', 'venv.Lib.site-packages.post', 'venv.Lib.site-packages.public',
              'venv.Lib.site-packages.request', 'venv.Lib.site-packages.query_string',
